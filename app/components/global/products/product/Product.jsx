...
const Product = ({ product, loading }) => {
  if (loading) {
    return (
      <div
        role="status"
        class="max-w-sm p-4 rounded-sm shadow-sm animate-pulse md:p-6 dark:border-gray-700"
      >
        <div class="flex items-center justify-center h-48 mb-4 bg-light-border-50 rounded-sm">
          <svg
            class="w-10 h-10 text-light-border"
            aria-hidden="true"
        ...
        <div class="h-5 bg-light-border-50 rounded-full w-9 mb-4"></div>
        <div class="h-4 bg-light-border-50 rounded-full mb-2.5"></div>
        <div class="h-4 bg-light-border-50 rounded-full w-20 mb-4"></div>
        <div class="h-2 bg-light-border-50 rounded-full mb-3"></div>
        <div class="h-2 bg-light-border-50 rounded-full mb-4 w-44"></div>
        <div class="flex justify-between items-center mt-4">
          <div class="h-5 bg-light-border-50 rounded-full w-9 mb-4"></div>
          <div class="h-8 bg-light-border-50 rounded-[10px] w-24 mb-4"></div>
        </div>
